...
<!-- Main Header Start -->
    ...
    <div class="filtrer">
            <!-- <div class="filtertype"> -->
                <form method="POST" action="produits2.php" >
            <div>
            <h4>Filtrer par type:</h4>
            <a href="produitscuisine.php"><input type="checkbox" name="type" value="Cuisine" onchange="cuisine()" checked="checked"> <label>Cuisine</label></a> <br/>
            ...
            <h4>Prix :</h4>
             ...
             De <input type="number" id="prixmin" name="min" width="50px" class="filterprice"> à <input type="number" name="max" width="50px;" class="filterprice">
            </div>
...
$set="";
 //$set=$_POST["rech"];
$_sql="select * from produitensolde where type='cuisine' ";
...
$set="";
$sql="select * from produit where type='cuisine' ";
