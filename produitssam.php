...
<!-- Main Header Start -->
    ...
    <div class="filtrer">
            ...
            <a href="produitssam.php"><input type="checkbox" name="type" value="SAM" onchange="sam()" checked="checked"> <label>Salle à manger</label></a><br/>
...
$set="";
 //$set=$_POST["rech"];
$_sql="select * from produitensolde where type='1' ";
